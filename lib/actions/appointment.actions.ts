    ...
    try {
        ...
        const smsMessage = `
            ...
            ${type === 'schedule' 
                ...
                : `We regret to inform that your appointment for ${formatDateTime(appointment.schedule!).dateTime} is cancelled for the following reason: ${appointment.cancellationReason}`
            }
        `;
